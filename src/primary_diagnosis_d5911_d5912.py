...
DATABASE = ROOT / "outputs/septic_shock/hm_cohort_septic_shock.duckdb"
...
def main() -> dict:
    ...
    report = ["# Primary-Discharge-Diagnosis Counts for D59.11 and D59.12", "",
              "Counts are restricted to the existing 2016–2022 adult hematologic-malignancy hospitalization cohort. A code qualifies only when it is an exact normalized match in the first diagnosis field.", "",
    ...
    summary = {"definition": "Exact D5911 or D5912 in diagnosis_codes[1]", "results": results,
